...
<div class="box border pl-5 pb-5"> 	 	
 	<h2 class="mt-5">Thêm mới quản trị viên</h2>
	<hr class="mb-5 w-75">
	...
	<fieldset>
	  <div class="form-group row">
	    ...
	    <div class="col-sm-8">
	      <input type="text" class="form-control" id="param_name" name = "name" value="<?php echo set_value('name') ?>" placeholder="your name">
	    </div>
	   ...
	   <div class="form-group row">
	    ...
	    <div class="col-sm-8">
	      <input type="text" class="form-control" id="param_name" name = "username" value = "<?php echo set_value('username') ?>" placeholder="your username">
	    </div>
