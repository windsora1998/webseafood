   ...
   ?>
     <table class="table table-hover table-striped mt-5">
      <thead>
        <tr>
          ...
          <th>Danh sách danh mục sản phẩm</th>
          <th></th>
          <th>Tổng số: <?php echo count($list); ?></th>
        </tr>
      </thead>
    ...
    <?php foreach ($list as $row):?>  
        ...
        <tr>
          ...
          <td>
            <a href="<?php echo admin_url('catalog/edit/'.$row->id) ?>"><span class="table-pause"><button type="button" class="btn btn-secondary btn-rounded btn-sm my-0"><i class="fas fa-tools"></i></button></span></a>

            <a onclick="deleteUser()" href="<?php echo admin_url('catalog/delete/'.$row->id) ?>"><span class="table-remove"><button type="button" class="btn btn-danger btn-rounded btn-sm my-0"><i class="fas fa-trash-alt"></i></button></span></a>
          </td>
        </tr>
    <?php endforeach; ?>
      </tbody>
