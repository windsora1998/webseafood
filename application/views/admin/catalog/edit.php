...
<div class="box border pl-5 pb-5"> 	 	
	...
	<fieldset>
	  ...
	  <div class="form-group row">
	    ...
	    <div class="col-sm-8">
	      <input type="text" class="form-control" id="param_name" name = "name" value="<?php echo $info->name ?>">
	    </div>
	...
	<div class="form-group row">
	  ...
	  <div class="form-group row">
	    ...
	    <div class="col-sm-8">
	      <input type="text" class="form-control" id="param_sort_order" name = "sort_order" value="<?php echo $info->sort_order ?>" >
	    </div>
	    <div class = "clear_error" name = "sort_order_error"> <?php echo form_error('sort_order'); ?> </div>	    	    
	  </div>		

	</fieldset>
	  <button type="submit" formaction = "" class="btn btn-primary mb-2" value = "Thêm mới">Update</button>  
	</form>
</div>
</html>
