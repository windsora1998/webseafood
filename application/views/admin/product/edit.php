...
<div class="box border pl-5 pb-5"> 	 	
	...
	<div class="form-group row">
	    ...
	    <div class="col-sm-8">
			...
			<img src="<?php echo base_url('upload/product/'.$info->image_link) ?>" alt="" style = "width: 100px; height: 70px">		    	
	    </div>
	    <!-- <div class = "clear_error" name = "name_error"> <?php echo form_error('name'); ?> </div>	    	    	    -->
	  </div>	
	...
	<div class="form-group row">
	    ...
	    <div class="col-sm-8">
	      <input type="text" class="form-control" id="param_price" value="<?php echo $info->price ?>" name = "price">
	    </div>
	    <!-- <div class = "clear_error" name = "name_error"> <?php echo form_error('name'); ?> </div>	    	     -->
	</div>		
	...
	<div class="form-group row">
	    ...
	    <div class="col-sm-8">
	      <input type="text" class="form-control" id="param_discout" value="<?php echo $info->discount ?>" name = "discount">
	    </div>
	    <!-- <div class = "clear_error" name = "name_error"> <?php echo form_error('name'); ?> </div>	    	     -->
	</div>		
	...
	<div class="form-group row">
	  ...
	  <button type="submit" formaction = "" class="btn btn-primary mb-2" id = "submit" name = "submit" value = "submit">Update</button>  
	</form>
</div>
</html>
